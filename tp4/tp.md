...
Ouverture d'un accès navigateur internet pour récupérer le fichier [Wireshark ping.pcap](ping.pcap)
...
* Le fichier HTTP et demandé par client1 (trame HTTP) et renvoyé par server1 (trame HTTP `text/html`)
